...
def tricky_method_two(a_string_param, an_array_param)
	...
	#This modification here to the passed argument disassociates it from the original object_id assigning it to an internal variable
end
...
puts "Current my string: #{my_string}"
puts "Current my array: #{my_array}"
...
# My solutions: 
# 1 Ternary operator with two comparators 
def color_valid1(color)
  color == "blue" || color == "green" ? true : false
end
puts color_valid1("red")
puts color_valid1("green")
puts color_valid1("blue")
puts "\n"

# 2 unless reserved keyword <-- couldn't get
def color_valid2(color)
  return true unless color != "blue" 
  return true unless color != "green"
  else 
  false 
end
...
#3 trailing if statement
def color_valid3(color)
  color == "blue"  || color == "green" if not false
end
...
puts color_valid4("red")
puts color_valid4("blue")
puts color_valid4("green")
